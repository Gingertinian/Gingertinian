...
```
Backend       TypeScript, NestJS, Prisma, PostgreSQL, Redis, BullMQ, Socket.io
Frontend      Vue 3, Pinia, Vite, Tailwind CSS, Vue Flow, D3.js, Three.js, Web Audio API, Yjs
GPU / ML      Python, CUDA, NVENC/NVDEC, OpenCV, PyTorch, Real-ESRGAN, InsightFace, FFmpeg
Infra         Docker, GitHub Actions, Railway, Vercel, RunPod Serverless, Cloudflare R2
Payments      Stripe, Coinbase Commerce, Plisio
```
